...
<body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
	...
	<div class="margintopmobile2 margintop2">
		<form action="old-mobile.php" method="post">
...
echo "<thead><tr><th>Date</th><th>Time</th><th>Location</th><th>Classroom</th><th>Intake</th><th>Module</th><th>Lecterur</th></tr></thead>";
	...
	echo "<p style='text-align: center;'> o_o <br>
		  A new website in trial <a href='http://apu-schedule.azurewebsites.net'>here</a><br>
...
<footer class="mdl-mini-footer footertweaks">
  <div class="mdl-mini-footer__left-section">
    ...
    <ul class="mdl-mini-footer__link-list">
      <li><a href="http://apu-schedule.azurewebsites.net/">New version</a></li>
	  <li><a href="http://apu-schedule.azurewebsites.net/old.php">Desktop site</a></li>
    </ul>
  </div>
</footer>
</div>
